...
/**
 * Logo Moded Brand will be used later to mod the svg logo in interactive way using
 * @returns
 */
const LogoModBrand = () => {
  ...
  return (
    <Container className="logo-container" onClick={handleClick}>
      ...
      >
        <defs>
          <linearGradient
            ...
            x2="545.83"
            y2="216.32"
            gradientTransform="translate(577.29 2.71) rotate(-179.46) scale(1 -1)"
...
/* Styled component for inline SVG */
